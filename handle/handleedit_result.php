...
if(isset($_SESSION['user_data'])){
	...
	$qr=mysqli_query($link,"select * from users where id='".$_REQUEST['student_id']."'");
	...
	foreach($marks_Array as $key=>$marks){
		$qr_update=mysqli_query($link,"UPDATE result_data set marks='".$marks."' where id='".$data_id[$key]."'");
	}
	header("Location:../result_home.php?success=Edited Successfully");
