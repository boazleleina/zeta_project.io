                ...
                <table class="table table-bordered table-striped p-3">
                    ...
                    <tbody>
                        <?php while($row=mysqli_fetch_array($result)){
                            ...
                            echo "<td><a href ='edit_lecturer.php?id=".$row['id']."'><span class ='fa fa-pencil'></span></a></td>";
                            echo "<td><a href ='delete_lecturer.php?id=".$row['id']."'><span class ='fa fa-trash'></span></a></td>";
                        }
