...
<body>
    <div class="container">
        ...
        <div>
            <form action="edit_lecturer.php" method="post" enctype="multipart/form-data">
                <div class="row mb-4">
                    <div class="col">
            ...
            <div class="text-center m-3 border-2">
                <p><a href="view_lecturer.php" class = "btn btn-outline-primary text-center m-3">BACK TO HOME</a></p>
            </div>
