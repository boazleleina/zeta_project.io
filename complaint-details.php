...
<?php include('student/navbar.php');?>
 ...
 <?php $query=mysqli_query($link, "select tblcomplaints.*,category.categoryName as catname from tblcomplaints join category on category.id=tblcomplaints.category where userId='".$_SESSION['id']."' and complaintNumber='".$_GET['cid']."'");
...
<?php $ret=mysqli_query($link, "select complaintremark.remark as remark,complaintremark.status as sstatus,complaintremark.remarkDate as rdate from complaintremark join tblcomplaints on tblcomplaints.complaintNumber=complaintremark.complaintNumber where complaintremark.complaintNumber='".$_GET['cid']."'");
...
<?php include('student/footer.php');?>
    ...
    <script src="user/assets/js/jquery.ui.touch-punch.min.js"></script>
