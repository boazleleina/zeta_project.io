...
$sql=mysqli_query($link, "insert into category(categoryName,categoryDescription) values('$category','$description')");
...
if(isset($_GET['del']))
		  {
		          mysqli_query($link, "delete from category where id = '".$_GET['id']."'");
