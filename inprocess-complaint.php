...
<?php 
$st='in process';
$query=mysqli_query($link, "select tblcomplaints.*,users.name as name from tblcomplaints join users on users.id=tblcomplaints.userId where tblcomplaints.status='$st'");
